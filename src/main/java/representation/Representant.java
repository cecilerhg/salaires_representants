...
public class Representant {
    ...
    private float[] ChiffreA = {0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f};

    public Representant(int numero, String nom, String prenom, ZoneGeographique secteur) {
        this.numero = numero;
        this.nom = nom;
        this.prenom = prenom;
        this.secteur = secteur; //MODIF
    }
    ...
    public ZoneGeographique getSecteur() { //MODIF
        return secteur;
    }
     ...
     *
     * @param mois le numéro du mois (de 0 à 11)
     * @param pourcentage le pourcentage (>= 0 ) à appliquer sur le CA réalisé
     * pour ce mois
     * @return le salaire pour ce mois, tenant compte du salaire fixe, de
    ...
    public float salaireMensuel(int mois, float pourcentage) {
        ...
        float sal;
        sal = this.salaireFixe + this.secteur.getIndemniteRepas() + this.ChiffreA[mois]*(pourcentage);
        return sal;
    }
